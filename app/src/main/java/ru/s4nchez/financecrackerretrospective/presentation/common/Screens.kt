...
import ru.s4nchez.financecrackerretrospective.presentation.transaction.TransactionCreationFragment
...
class TransactionCreationScreen(private val walletId: Long) : SupportAppScreen() {
    override fun getFragment(): Fragment {
        return TransactionCreationFragment.createNewTransaction(walletId)
    }
}